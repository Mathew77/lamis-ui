...
const PatientRegistrationPage = React.lazy(() =>
  import('components/patient/PatientRegistrationPage'),
);
const CheckInPage = React.lazy(() =>
  import('./components/CheckIn/CheckInPage'),
);
...
const EnrollmentList = React.lazy(() =>
  import('components/Hiv/EnrollmentList'),
);
const HtsList = React.lazy(() => import('components/Hts/HtsList'));
const RiskAssessment = React.lazy(() =>
  import('components/Hts/RiskAssessment'),
);
const HtsServices = React.lazy(() => import('components/Hts/HtsServices'));
const EnrollPatient = React.lazy(() => import('components/Hiv/EnrollPatient'));
const EnrolledPatients = React.lazy(() =>
  import('components/Hiv/EnrolledPatients'),
);
const EnrolledPatientsDashboard = React.lazy(() =>
  import('components/Hiv/EnrolledPatientsDashboard'),
);
const ClientStatusSearch = React.lazy(() =>
  import('components/ClientStatusUpdate/ClientStatusSearch'),
);
const NewClientStatus = React.lazy(() =>
  import('components/ClientStatusUpdate/NewClientStatus'),
);
const ViewClientStatusList = React.lazy(() =>
  import('components/ClientStatusUpdate/ViewClientStatusList'),
);
const ViewStatusSearch = React.lazy(() =>
  import('components/ClientStatusUpdate/ViewStatusSearch'),
);
const ArtClinic = React.lazy(() => import('components/Hiv/ArtClinic'));
const IndexContactSearch = React.lazy(() =>
  import('components/Hts/IndexContactSearch'),
);
const NewIndexContact = React.lazy(() =>
  import('components/Hts/NewIndexContact'),
);
...
//modified React.component to component
const Routes = (props) => {
  return (
          ...
          <MainLayout breakpoint={props.breakpoint}>
            <React.Suspense fallback={<PageSpinner />}>
              ...
              <Route
                ...
                component={EnrolledPatients}
              />
              <Route
                exact
                path="/client-status"
                component={ClientStatusSearch}
              />
              <Route exact path="/new-status" component={NewClientStatus} />
              <Route
                exact
                path="/View-status"
                component={ViewClientStatusList}
              />
              <Route exact path="/art-clinic" component={ArtClinic} />
              <Route
                exact
                path="/index-Search"
                component={IndexContactSearch}
              />
              <Route exact path="/View-client" component={ViewStatusSearch} />
