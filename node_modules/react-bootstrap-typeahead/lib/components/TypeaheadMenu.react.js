...
var defaultProps = {
  ...
  renderMenuItemChildren: function renderMenuItemChildren(option, props, idx) {
    return React.createElement(_Highlighter["default"], {
      search: props.text
...
function (_React$Component) {
  ...
  function TypeaheadMenu() {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_renderMenuItem", function (option, idx) {
      ...
      if (option.customOption) {
        return React.createElement(_MenuItem["default"], (0, _extends2["default"])({}, menuItemProps, {
          className: "rbt-menu-custom-option",
          label: newSelectionPrefix + label
        }), newSelectionPrefix, React.createElement(_Highlighter["default"], {
          search: text
        }, label));
      }

      if (option.paginationOption) {
        return [React.createElement(_Menu["default"].Divider, {
          key: "pagination-item-divider"
        }), React.createElement(_MenuItem["default"], (0, _extends2["default"])({}, menuItemProps, {
      ...
      return React.createElement(_MenuItem["default"], menuItemProps, renderMenuItemChildren(option, _this.props, idx));
    });
    return _this;
  }
  ...
  _proto.render = function render() {
    ...
    return (// $FlowFixMe: Improve typing for spread props.
      React.createElement(_Menu["default"], menuProps, options.map(this._renderMenuItem))
    );
  };
