...
function usePrefersDarkMode() {
    return _1.useMedia(usePrefersDarkModeQueries, usePrefersDarkModeValues, usePrefersDarkModeDefaultValue, true);
}
function useDarkMode(className, element) {
    ...
    var _a = _1.useLocalStorage('dark-mode-enabled', undefined), enabledState = _a[0], setEnabledState = _a[1];
