...
export function useMedia(queries, values, defaultValue, useDependencies) {
    if (useDependencies === void 0) { useDependencies = false; }
    // Array containing a media query list for each query
    var mediaQueryLists = useMemo(function () { return queries.map(function (q) { return window.matchMedia(q); }); }, 
